...
TEST(CG_Throughput, kron17_15threads) {
	run_test(131072, 4474931789, 15);
}
TEST(CG_Throughput, kron17_20threads) {
	run_test(131072, 4474931789, 20);
}
TEST(CG_Throughput, kron17_24threads) {
	run_test(131072, 4474931789, 24);
}
TEST(CG_Throughput, kron17_30threads) {
	run_test(131072, 4474931789, 30);
}
TEST(CG_Throughput, kron17_40threads) {
	run_test(131072, 4474931789, 40);
}
TEST(CG_Throughput, kron17_48threads) {
	run_test(131072, 4474931789, 48);
}
...
TEST(CG_Throughput_Rand, kron17_48threads) {
	run_randomized(131072, 4474931789, 48);
}
